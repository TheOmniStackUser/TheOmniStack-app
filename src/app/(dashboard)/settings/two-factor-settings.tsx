...
export function TwoFactorSettings({ initialEnabled }: Props) {
  ...
  if (isEnabled) {
    return (
      <CollapsibleSection
        title="Zweistufige Authentifizierung (2FA)"
        subtitle="Dein Konto ist mit einem zusätzlichen Sicherheitsschritt geschützt."
        icon={
  ...
  return (
    <CollapsibleSection
      title="Zweistufige Authentifizierung (2FA)"
      subtitle="Erhöhe die Sicherheit deines Kontos durch einen zusätzlichen Code bei jedem Login."
      icon={
        ...
        {!showSetup ? (
          <div>
            <button
              ...
              disabled={isLoading}
              className="px-6 py-2 rounded-xl bg-slate-900 text-white font-semibold hover:bg-slate-800 transition-all flex items-center gap-2 cursor-pointer"
            >
              ...
              <div className="space-y-4">
                ...
                <form action={async (fd) => {
                  ...
                  <div className="flex gap-3">
                    <button
                      type="submit"
                      className="flex-1 py-2 rounded-xl bg-slate-900 text-white font-semibold hover:bg-slate-800 transition-all cursor-pointer"
                    >
                      Aktivieren
                    </button>
                    <button
