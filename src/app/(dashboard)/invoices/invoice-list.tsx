                         ...
                         {invoice.status !== 'draft' && (
                           <div className="border-b border-slate-100 py-1">
                             <button
                               onClick={() => { handleDownload(invoice.id); setActiveRowMenuId(null); }}
                               disabled={!invoice.pdfStorageKey}
                               className="w-full flex items-center justify-between px-3 py-2 hover:bg-slate-50 text-slate-700 font-bold transition-all text-left disabled:opacity-40"
                             >
                               <div className="flex items-center gap-2">
                             ...
                             <button
                               ...
                               className="w-full flex items-center justify-between px-3 py-2 hover:bg-slate-50 text-slate-700 transition-all text-left"
                             >
                               <div className="flex items-center gap-2">
