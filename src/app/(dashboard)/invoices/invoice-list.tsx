  ...
  const sortedInvoices = [...filteredInvoices].sort((a, b) => {
    ...
    switch (sortField) {
      ...
      case 'marketplaceOrderId':
        valA = a.marketplaceOrderId || ''
        valB = b.marketplaceOrderId || ''
        break
      case 'type':
                    ...
                    <button
                      ...
                      {activeRowMenuId === invoice.id && menuPosition && createPortal(
                        ...
                        >
                           ...
                           <div className="pb-1 border-b border-slate-100 flex flex-col">
                             {!invoice.pdfStorageKey ? (
                               <span className="flex w-full items-center gap-2 px-4 py-2.5 text-left text-sm text-slate-400 bg-slate-50/30 cursor-not-allowed select-none whitespace-nowrap">
                                 <svg className="w-4 h-4 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10" /></svg>
                                 PDF herunterladen
                               </span>
                             ) : (
                               <button
                                 ...
                                 className="flex w-full items-center gap-2 px-4 py-2.5 text-left text-sm text-blue-700 hover:bg-blue-50/50 transition-colors whitespace-nowrap font-bold"
                                >
                                 <svg className="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10" /></svg>
                                 PDF herunterladen
                               </button>
                             )}
                             <button
                             ...
                             <button
                               ...
                               className="flex w-full items-center gap-2 px-4 py-2.5 text-left text-sm text-slate-700 hover:bg-slate-50 transition-colors whitespace-nowrap font-bold"
                             >
                         ...
                         {(invoice.status === 'issued' && !isPaid(invoice)) && (
                           <div className="border-t border-slate-100 py-1">
                             <button
                               ...
                               className="flex w-full items-center gap-2 px-4 py-2.5 text-left text-sm text-red-600 hover:bg-red-50 transition-colors whitespace-nowrap font-bold"
                             >
                         ...
                         <div className="border-t border-slate-100 py-1 flex flex-col">
                           {invoice.status === 'draft' && (
                             <button
                               type="button"
                               onClick={async () => {
                           ...
                           <Link
                             ...
                             onClick={() => setActiveRowMenuId(null)}
                             className="flex w-full items-center gap-2 px-4 py-2.5 text-left text-sm text-slate-700 hover:bg-slate-50 transition-colors whitespace-nowrap border-t border-slate-100"
                           >
                             <svg className="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <>
                              ...
                              <div className="absolute right-0 bottom-full mb-1 sm:bottom-auto sm:top-full sm:mt-1 bg-white border border-slate-200 rounded-xl shadow-xl py-1.5 z-[60] w-48 overflow-hidden">
                                ...
                                <a
                                  ...
                                  onClick={() => setShowMoreMenu(false)}
                                  className="w-full text-left px-4 py-2 hover:bg-slate-50 text-xs font-bold text-slate-700 hover:text-slate-800 flex items-center gap-2 border-t border-slate-100"
                                >
                                  <svg className="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2" />
                                  </svg>
