  ...
  const order = await db.transaction(async (tx) => {
    ...
    const [newOrder] = await tx
      ...
      .values({
        ...
        buyerCompany: data.customer.companyName || null,
        shippingName: data.customer.name || null,
        shippingCompany: data.customer.companyName || null,
  ...
  try {
    ...
    const [newOrder] = await db
      ...
      .values({
        ...
        buyerCompany: quote.recipientCompany || null,
        shippingName: quote.recipientName || '',
        shippingCompany: quote.recipientCompany || null,
